                      ...
                      children: [
                        ...
                        Expanded(
                          ...
                          onTap: () {
                            ...
                            // }
                            debugPrint(
                                'file size : ${controller.image.value.readAsBytesSync().lengthInBytes / 1024}');
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormFieldWithLabel(
                                      controller:
                                          controller.academic_title.value,
                                    ...
                                    DropdownWithLabel(
                                      ...
                                      validator: (value) {
                                        if (value == null) {
                                          ...
                                          controller.motherToungue.value =
                                              value;
                                          return null;
                                        }
                                      },
                                    ...
                                    InkWell(
                                      onTap: () {
                                        PickerCustom.countryPicker((value) {
                                          ...
                                          controller.country_code.value = value;
                                        });
                                      },
                                    ...
                                    if (controller.agreementError.value)
                                      CustomError(
                                        text:
                                            'Agreement checkbox is required'.tr,
                                      ),
