    ...
    return GetBuilder(
      ...
      builder: ((controller) => Obx(
            () => WillPopScope(
              ...
              child: controller.examDetailData.isEmpty
                  ? Container(
                      color: Colors.white,
                    )
                  : Scaffold(
                      appBar: AppBarStyle(
                        title: controller.examDetailData['title'] != null
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                '${controller.examDetailData['sale_price'] ?? controller.examDetailData['price']} €',
                              ...
                              Expanded(
                                  child: DateTime.parse(
                                                  '${controller.examDetailData['reg_until_date']}')
                                      ...
                                      : ElevatedButtonCustoms(
                                          onTap: () {
                                            if (!(controller.isBooked.value ||
                                              ...
                                              if (kTOKENSAVED != "") {
                                                ...
                                                BookingForm(
                                                  examDetails: controller
                                                      .examDetailData.value,
                                          ...
                                          text:
                                              '${controller.isBooked.value ? 'ALREADY BOOKED'.tr : (controller.examDetailData['available_seats'] != null && controller.examDetailData['available_seats'] == 0) ? 'SEATS NOT AVAILABLE'.tr : 'BOOK NOW'.tr}',
                                          colorBG:
                                              ColorStyle.primaryColor_1570A5,
                                        ))
                            ],
                                              ...
                                              children: [
                                                ...
                                                if (controller.examDetailData[
                                                    ...
                                                    controller.examDetailData[
                                                        ...
                                                        null)
                                                  Text(
                                                    '${controller.examDetailData['available_seats'] ?? '400'}/${controller.examDetailData['total_seat'] ?? '500'}',
                                                    style: TextStylesCustom.textStyles_14.apply(
                                                        color: circleColor((controller
                                                                            .examDetailData[
                                                                        'available_seats'] *
                                              ...
                                              children: [
                                                ...
                                                Expanded(
                                                  ...
                                                  controller.examDetailData[
                                                              'exam_date'] !=
                                                          null
                                                      ? '${DateFormat('dd/MM/yyyy (EE)').format(DateTime.parse('${controller.examDetailData['exam_date']}'))}'
                                                      : '',
                                                  style: TextStylesCustom
                                                      .textStyles_14
                                                      .apply(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  controller.examDetailData[
                                                              'exam_time'] !=
                                                          null
                                                      ? '${DateFormat.jm().format(DateTime.parse('${controller.examDetailData['exam_date']}T${controller.examDetailData['exam_time']}'))}'
                                                      : '',
                                                  style: TextStylesCustom
                                                      .textStyles_14
                                                      .apply(
